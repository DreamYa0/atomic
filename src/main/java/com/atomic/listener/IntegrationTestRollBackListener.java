    ...
    public void onStart(ITestContext testContext) {
        ...
        if (dbNameAndChanges.size() > 0) {
            ...
            for (Map.Entry<String, Changes> map : entries) {
                RollBack.newInstance().setStartPoint(map.getValue(), map.getKey(), tableNameList.get(map.getKey()));
            }
        }
    }
            ...
            try {
                try {
                    ...
                    for (Map.Entry<String, Changes> map : entries) {
                        ...
                        RollBack.newInstance().setStartPoint(map.getValue(), map.getKey(), tableNames);
                    }
