...
public class SoaMockListener implements TestExecutionListener {
    ...
    private ApplicationContext getApplicationContext(TestContext testContext) throws IllegalAccessException, InvocationTargetException {
        if (applicationContext == null) {
            applicationContext = (ApplicationContext) ReflectionUtils.invokeMethod(GET_APPLICATION_CONTEXT, testContext);
        }
