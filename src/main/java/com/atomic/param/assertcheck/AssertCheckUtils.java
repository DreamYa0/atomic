...
import com.atomic.param.assertcheck.entity.AssertItem;
import com.atomic.param.assertcheck.entity.SqlEntity;
import com.atomic.param.assertcheck.enums.AssertType;
import com.atomic.param.assertcheck.enums.CompareType;
...
public final class AssertCheckUtils {
    ...
    private static Object getRealValue(Map<String, Object> param, String field) throws SQLException {
        ...
        if (value instanceof String) {
            value = StringUtils.getSqlValue(value.toString(), String.class);
            // 把入参里面的 sql 语句改成真实的值
